...
public class DepartmentUnitTests {
  ...
  public void testGetDepartmentChair() {
    assertEquals("Luca Carloni", department.getDepartmentChair(),
            "The department chair is 'Luca Carloni'.");
  }
  ...
  public void testDropPersonFromMajor() {
    ...
    Department tempDept = new Department("CHEM", new HashMap<>(),
            "Laura J. Kaufman", 0);
  ...
  public void testAddCourse() {
    ...
    assertEquals(newCourse, department.getCourseSelection().get("3157"),
            "The new course adds to the department.");
  }

  @Test
  public void testCreateCourse() {
    department.createCourse("3203", "Ansaf Salleb-Aouissi",
            locations[2], times[2], 250);

    Course createdCourse = department.getCourseSelection().get("3203");
    assertEquals("Ansaf Salleb-Aouissi", createdCourse.getInstructorName(),
